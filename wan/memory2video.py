...
class WanM2V:
    ...
    def __init__(
        ...
        logging.info(f"Creating WanModel_Memory from {checkpoint_dir}")
        self.low_noise_model = WanModel_Memory.from_pretrained(
        ...
        self.high_noise_model = WanModel_Memory.from_pretrained(
