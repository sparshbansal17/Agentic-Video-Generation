...
def build_prompt(payload: dict[str, Any], compact: dict[str, Any]) -> str:
    return (
        ...
        + ". Each report must include reviewer, passed, scores, failure_reasons, evidence. "
        "Evidence must be a short object, not an array, and must not include file paths. "
        "Use phrases like 'sampled_frames_checked': true and short observations. "
        ...
        "Be concrete and concise. Context JSON:\n"
